...
public class importantNotic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_important_notic);
        ...
        reference.child("pp").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(importantNotic.this,error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
